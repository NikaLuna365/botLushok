...
ВАЖНО: Не повторяй уже описанную информацию, если она уже была упомянута ранее. Отвечай на то сообщение, на которое сроботал триггер, а всё остальное служить контекстом. 
